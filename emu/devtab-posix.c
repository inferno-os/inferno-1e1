...
Rune	devchar[] = { '/', 's', 'U', 'M', 'c', 'D', 'd', 'I', 'C', 'p', 'A', 0 };
...
Dev	devtab[] =
{
	...
	/* Audio device */
	{
		audioinit,	audioattach,	audioclone,	audiowalk,
		audiostat,	audioopen,	audiocreate,	audioclose,
		audioread,	audiobread,	audiowrite,	audiobwrite,
		audioremove,	audiowstat
	},
};
