...
/*	Unfortunately, Unix and Plan 9 have incompatible dup() functions.
 *	Mk should call os_dup2() to get the proper implementation.
 *	If someone forgets, this dup macro causes a compilation failure.
 *
 *	The os-... files should undef dup to access the system version.
 */

#define dup(x, y)	dup_should_be___os_dup2.(x, y)
