...
i960boot(int fd, Fhdr *fp, ExecHdr *hp)
{
	...
	USED(fd);
	settext(fp, hp->e.i960exec.i6hdr.i6entry, hp->e.i960exec.i6texts.virt, hp->e.i960exec.i6texts.size,
					hp->e.i960exec.i6texts.fptr);
	setdata(fp, hp->e.i960exec.i6datas.virt, hp->e.i960exec.i6datas.size,
				hp->e.i960exec.i6datas.fptr, hp->e.i960exec.i6hdr.i6bsssize);
	setsym(fp, 0, 0, 0, 0);
...
elfdotout(int fd, Fhdr *fp, ExecHdr *hp)
{
	...
	fp->name = "IRIX 5.X a.out executable";
	free(es);
	return 1;
bad:
	free(es);
