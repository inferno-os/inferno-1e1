...
z8530setup0(Uart *p, int brsource)
{
	...
	p->oq = qopen(4*1024, 0, z8530kick, p);
}
...
void
z8530create(Chan *c, char *name, int omode, ulong perm)
{
...
long
z8530read(Chan *c, void *buf, long n, ulong offset)
{
	Uart *p;
...
Block*
z8530bread(Chan *c, long n, ulong offset)
{
...
long
z8530write(Chan *c, void *buf, long n, ulong offset)
{
	Uart *p;
	char cmd[32];
...
long
z8530bwrite(Chan *c, Block *bp, ulong offset)
{
