...
/* General */
extern	void		tkaction(TkAction**, int, int, char*, int);
...
extern	void		tkdrawcanv(Tk*, Point);
extern	void		tkdrawframe(Tk*, Point);
extern	void		tkdrawlabel(Tk*, Point);
extern	void		tkdrawscale(Tk*, Point);
extern	void		tkdrawlistb(Tk*, Point);
extern	void		tkdrawrelief(Image*, Tk*, Point*, int);
extern	void		tkdrawscrlb(Tk*, Point);
extern	void		tkdrawstring(Tk*, Image*, Point, char*, int, int);
extern	void		tkdrawtext(Tk*, Point);
...
extern	void		tkdrawentry(Tk*, Point);
...
extern	void		tkdrawslaves(Tk*, Point);
