...
starturl: con "http://inferno.bell-labs.com/inferno/index.html";
...
image(base: string, color: ref Image, h: ref Lex, listtype: list of int): (ref Image, ref Image, string)
{
	...
	if(pic == nil){
		...
		x := len listtype * 15;
		pic = display.newimage(((x,0), (300+x,50)), red.ldepth, 0, 0);
...
{
	pic := display.newimage(((0,0), (Width,2)), red.ldepth, 0, Draw->Black);
