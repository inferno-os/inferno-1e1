...
include "draw.m";
draw: Draw;
Context, Display, Font, Point, Image, Screen: import draw;
...
#			display.color(130));			# highlightcolor
	...
	comic := open("/services/comics/config", sys->OREAD);
	if(comic == nil) {
		print("open comic: %r");
		return;
	}
...
view(ctxt: ref Context, title: ref Image, author, bitmap: string)
{
	...
	byline.append(Element.separator(env, ((0,0), (15,0)), ones, display.zeros));
