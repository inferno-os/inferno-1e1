...
task_cfg := array[] of {
	...
	"scale .b.Rate -from 1 -to 10 -orient horizontal -showvalue 0 -command {send cmd rate}",
	"scale .b.Jitter -from 0 -to 5 -orient horizontal -showvalue 0 -command {send cmd jitter}",
	"scale .b.Skip -from 0 -to 25 -orient horizontal -showvalue 0 -command {send cmd skip}",
	".b.Rate set 3",
	".b.Jitter set 2",
	".b.Skip set 5",
...
init(ctxt: ref Context, argv: list of string)
{
	...
	menubut := wmlib->titlebar(t, "Infernal Coffee", 0);
